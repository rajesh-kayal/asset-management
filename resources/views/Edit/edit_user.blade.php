...
<body>
    <div class="mainWrapper">
        ...
        <div class="admin odd configuration" style="padding-bottom:15px;">
            <h3 class="title"><span>Edit User</span></h3>
            <div class="proTable">
                <div class="row">
                    <div class="col-sm-6">
                        <div class="proRow">
                            <h2>Name</h2>
                            <input type="text" placeholder="Enter User Name" name="name" value="{{ $user->name }}">
                        </div>
                        ...
                        <div class="proRow">
                            ...
                            <div class="input-group">
                                ...
                                <input type="tel" class="form-control" placeholder="Enter User Number" name="phoneNumber" value="{{ $user->phone_number }}">
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-6">
                        <div class="proRow">
                            <h2>Asset</h2>
                            <input type="text" placeholder="Asset" name="asset" value="{{ $user->asset }}">
                        </div>
                    </div>
                </div>
            </div>
