    ...
    <div class="mainWrapper">
        <div class="header">
            ...
            <div rel="sticky" data-scroll-top="true" class="adminHeader clearfix">
                ...
                <form action="{{ url('/update-location') }}" method="post">
                    @csrf
        ...
        <div class="admin odd configuration" style="padding-bottom:15px;">
            <h3 class="title"><span>Edit Location</span></h3>
            <div class="proTable">
                <form action="{{ url('/update-location') }}" method="post">
                    @csrf
                    <input type="hidden" name="location_id" value="{{ $location->id }}">
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="proRow">
                                <h2>Location Code</h2>
                                <input type="text" placeholder="Enter Location Code" name="locationCode" value="{{ $location->code ?? '' }}">
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="proRow">
                                <h2>Location Name</h2>
                                <input type="text" placeholder="Enter Location Name" name="locationName" value="{{ $location->name ?? '' }}">
                            </div>
                        </div>
                    </div>
                </form>
