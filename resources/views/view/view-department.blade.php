...
<body>
    <div class="mainWrapper">
        ...
        <div class="admin odd configuration" style="padding-bottom:15px;">
            <h3 class="title"><span>View Department</span></h3>
            <div class="proTable">
                        <div class="row">
                        <div class="col-sm-12">
                            <div class="proRoww">
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="proRow">
                                <h2>Program Code</h2>
                                <input type="text" disabled placeholder="Enter Program Code" name="programCode" value="{{ $department->program_code ?? '' }}">
                            </div>
                            <div class="proRow">
                                <h2>Department Code</h2>
                                <input type="text" disabled placeholder="Enter Department Code" name="departmentCode" value="{{ $department->department_code ?? '' }}">
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="proRow">
                                <h2>Program Name</h2>
                                <input type="text" disabled placeholder="Enter Program Name" name="programName" value="{{ $department->program_name ?? '' }}">
                            </div>
                            <div class="proRow">
                                <h2>Department Description</h2>
                                <input type="text" disabled placeholder="Enter Department Description" name="departmentDescription" value="{{ $department->department_description ?? '' }}">
                            </div>
                        </div>
                    </div>
                </form>
