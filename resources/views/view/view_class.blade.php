...
<body>
    <div class="mainWrapper">
        ...
        <div class="admin odd configuration" style="padding-bottom:15px;">
            <h3 class="title"><span>View Class</span></h3>
            <div class="proTable">
                <div class="row">
                    <div class="col-sm-6">
                        <div class="proRow">
                            <h2>Class ID</h2>
                            <input type="text" value="{{ $class->class_id }}" name="class_id" disabled>
                        </div>
                        <div class="proRow">
                            <h2>Asset Life</h2>
                            <select name="asset_life" disabled>
                    ...
                    <div class="col-sm-6">
                        <div class="proRow">
                            ...
                            <input type="text" value="{{ $class->class_description }}" name="class_description" disabled>
                        </div>
