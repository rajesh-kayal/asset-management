...
<body>
    <div class="mainWrapper">
        ...
        <div class="admin odd configuration" style="padding-bottom:15px;">
            <h3 class="title"><span>View Location</span></h3>
            <div class="proTable">
                <form action="#">
                    @csrf
                    <input type="hidden" name="location_id" value="{{ $location->id }}">
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="proRow">
                                <h2>Location Code</h2>
                                <input type="text" disabled placeholder="Enter Location Code" name="locationCode" value="{{ $location->code ?? '' }}">
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="proRow">
                                <h2>Location Name</h2>
                                <input type="text" disabled placeholder="Enter Location Name" name="locationName" value="{{ $location->name ?? '' }}">
                            </div>
                        </div>
                    </div>
                </form>
