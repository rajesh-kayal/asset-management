...
<div class="mainWrapper">
    ...
    <div class="admin odd configuration" style="padding-bottom:15px;">
        <h3 class="title"><span>New User</span></h3>
        <div class="proTable">
        	<div class="row">
            	<div class="col-sm-6">
                    <div class="proRow">
                    ...
                    <div class="proRow">
                        ...
                        <select name="designation">
                            ...
                            <option >Jr PHP Laravel Developer</option>
                            <option >Sr Laravel Developer</option>
                            <option >Front End UI / React JS Developer</option>
                    ...
                    <div class="proRow">
                        ...
                        <input type="tel" class="form-control" placeholder="Enter User Number" name="phoneNumber">
                    </div>
                </div>
                </div>
                <div class="col-sm-6">
                    <div class="proRow">
                        <h2>Asset</h2>
                        <input type="text" placeholder="Asset" name="asset">
                    </div>
                </div>
            </div>
        </div>
