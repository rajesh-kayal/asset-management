...
<div class="mainWrapper">
                ...
                <div class="collapse navbar-collapse" id="navbar-collapse">
                    <ul class="nav navbar-nav navbar-right eform-right">
                        ...
                        <li class="dropdown firstDrop">
                                        ...
                                        <li ng-repeat="as in notification" style="padding:5px 5px;" class="ng-scope">
                                            <a href="javascript:void(0);" style="display: block;">
                                                ...
                                                <div class="menu-info" style="top: -6px;">
                                                    <h4 class="ng-binding">generalAction is Rejected 5126</h4>
                                                </div>
                                            </a>
                            ...
                            <!-- <ul class="dropdown-menu ng-hide" ng-show="(notification.length==0)">
    ...
    <!-- ng-show="(notification.length>0)? notification.length:''" -->
        ...
        <div rel="sticky" data-scroll-top="true" class="adminHeader clearfix">
                ...
                <div class="col-sm-6">
                    <div class="newPro">
                        <a href="{{ url('/new-pro') }}">New Asset</a>
                    </div>
                </div>
        </div>
    </div>
        	...
        	<table id="example" class="table table-striped table-bordered table-hover tch" style="width:100%">
                ...
                <tbody>
                    <tr>
                        ...
                        <td>
                            <div class="supplyOuter">
                                <div class="suppy"><span>04/06/2018</span></div>
                            </div>
                        </td>
                        <td>
                            <div class="supplyOuter">
                                <div class="suppy"><span>Gate</span></div>
                            </div>
                        </td>
                        <td>
                            <div class="supplyOuter">
                                <div class="suppy"><span>Building and Building Improvements</span></div>
                            </div>
                        </td>
                        <td>
                            <div class="supplyOuter">
                                <div class="suppy"><span>Furniture & Accessories</span></div>
                            </div>
                        </td>
                        <td>
                            <div class="supplyOuter">
                                <div class="suppy"><span>Abc Supplier</span></div>
                            </div>
                        </td>
                        <td>
                            <div class="supplyOuter">
                                <div class="suppy"><span>In Production</span></div>
                            </div>
                        </td>
                        <td>
                            <div class="supplyOuter">
                                <div class="suppy"><span>4900</span></div>
                            </div>
                        </td>
                        <td>
                            <div class="supplyOuter">
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="supplyOuter">
                                <div class="suppy"><span>Swinging</span></div>
                            </div>
                        </td>
                        <td>
                            <div class="supplyOuter">
                        ...
                        <td>
                            <div class="supplyOuter">
                                <div class="suppy"><span>XYZ Supplier</span></div>
                            </div>
                        </td>
                        <td>
                            <div class="supplyOuter">
                        ...
                        <td>
                            <div class="supplyOuter">
                                <div class="suppy"><span>1900</span></div>
                            </div>
                        </td>
                        <td>
                            <div class="supplyOuter">
