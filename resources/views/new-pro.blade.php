...
<div class="mainWrapper">
    ...
    <!-- ng-show="(notification.length>0)? notification.length:''" -->
        ...
        <div rel="sticky" data-scroll-top="true" class="adminHeader clearfix">
                <div class="col-sm-6"><h3 class="lead"><a href="product.html"><span><img src="images/back.png" alt=""></span><span>Back to Assets</span></a></h3></div>
                <div class="col-sm-6">
                    <div class="newPro">
                    	<a href="product.html" class="cnn">Cancel</a>
                        <a href="#">Save</a>
                    </div>
                </div>
        </div>
        	...
        	<div class="row">
            	<div class="col-sm-6">
                    ...
                    <div class="proRow">
                        ...
                        <select>
                        	<option>Land</option>
                            <option>Building and Building Improvements</option>
                        </select>
                    </div>
                    <div class="proRow">
                    	<h2>Asset Name</h2>
...
<script>
  $(document).ready(function(){
    ...
    $(".mainWrapper, .leftPanel").css("min-height", winHeight);
  });
