...
<div class="mainWrapper">
    <div class="header">
        ...
        <div rel="sticky" data-scroll-top="true" class="adminHeader clearfix">
            ...
            <form action="{{ url('/Next_year_Depreciations') }}" method="post" enctype="multipart/form-data">
            @csrf
        <input type="hidden" name="Company_accumulated_depreciation" value="{{ $asset->Company_accumulated_depreciation }}">
            <div class="col-sm-6">
                <div class="newPro">
        ...
        <div class="row">
            ...
            <div class="col-sm-6">
                ...
                <div class="col-sm-6">
                    <div class="proRow">
                        ...
                        <input type="hidden" value="{{ $asset->Class_code }}" name="Class_code">
                ...
                <div class="col-sm-6">
                    <div class="proRow">
                        ...
                        {{-- <select name="asset_vendor"> --}}
                            <input type="text" value="{{ $asset->asset_vendor }}" name="asset_vendor" disabled>
            ...
            <div class="row">
                <div class="col-sm-6">
                    <div class="proRow">
                        <h2>Quantity</h2>
                        <input type="text" value="{{ $asset->quantity }}" name="quantity" disabled>
                    </div>
                    <div class="proRow">
                        <h2>Purchase Date</h2>
                        <input type="text" value="{{ $asset->purchase_date }}" name="purchase_date" disabled>
                    </div>
                ...
                <div class="col-sm-6">
                    ...
                    <div class="proRow">
                        ...
                        <input type="text"  name="depreciations" value="">
                    </div>
